...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    welcomeSubtitle: 'Estructuración de jerarquías de datos profundas, libro de calificaciones interactivo tipo hoja de cálculo en tiempo real, seguimiento matricial de asistencia y control centralizado de aulas virtuales.',
    ...
    autoSaveActive: 'Auto-guardado activo en memoria local',
  ...
  en: {
    ...
    welcomeTitle2: 'Uniperium Academic Portal',
    welcomeSubtitle: 'Deep hierarchical academic structures, live spreadsheet-style gradebooks with dynamic formula recalculation, matrix attendance tracking, and centralized virtual room orchestration.',
    ...
    autoSaveActive: 'Autosave active in local storage',
